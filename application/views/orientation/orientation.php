		...
		<div class="col-md-12 ">
			<div class="card">
				<div class="card-header" style="background: linear-gradient(to left, #b51b67, #652387); ">
					<h3 class="text-white">Effectuer votre orientation dans: </h3>
				</div>
				<div class="card-body">
					<div class="row justify-content-around custom-line">
						<?php
							foreach ($type_enseignement as $te){?>
								<div class="col-md-4 ">
									<a href="<?=base_url( $te->url.'/'.$te->id ) ?>">
						...
						?>
<!--						<div class="col-md-4 ">-->
<!--							<div class="card bg-gradient-warning enseignement" >-->
<!--								<div class="card-body text-lg-center">-->
<!--<!--									<img src="--><?////= img('images/estp.jpg')?><!--<" class="card-img-absolute rounded" alt="circle-image" height="80%" width="80%"><br><br>-->
<!--									<a href="--><?//=base_url('Orientation/GetOption/1') ?><!--"><h2 class="text-capitalize"><strong class="">l'enseignement secondaire technique et professionnel </strong> </h2></a>-->
<!--									<p class="text-uppercase ">(estp)</p>-->
<!--								</div>-->
<!--							</div>-->
<!--						</div>-->
<!--						<div class="col-md-4">-->
<!--							<div class="card bg-gradient-info enseignement">-->
<!--								<div class="card-body text-lg-center">-->
<!--									<a href="--><?//=base_url('Orientation/GetOption/2') ?><!--"><h2 class="text-capitalize"><strong class="">l'enseignement général </strong> </h2></a>-->
<!--									<p class="text-uppercase ">(esg)</p>-->
<!--								</div>-->
<!--							</div>-->
<!--						</div>-->
					</div>
